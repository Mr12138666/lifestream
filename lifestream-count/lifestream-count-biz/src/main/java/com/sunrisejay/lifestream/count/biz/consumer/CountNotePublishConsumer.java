...
import com.sunrisejay.lifestream.count.biz.model.dto.NoteOperateMqDTO;
...
@Component
@RocketMQMessageListener(consumerGroup = "lifestream_group_" + MQConstants.TOPIC_NOTE_OPERATE, // Group 组
