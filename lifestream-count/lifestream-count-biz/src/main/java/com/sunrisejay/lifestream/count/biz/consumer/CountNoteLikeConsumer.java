package com.sunrisejay.lifestream.count.biz.consumer;
...
import com.sunrisejay.lifestream.count.biz.constant.RedisKeyConstants;
import com.sunrisejay.lifestream.count.biz.enums.LikeUnlikeNoteTypeEnum;
import com.sunrisejay.lifestream.count.biz.model.dto.AggregationCountLikeUnlikeNoteMqDTO;
import com.sunrisejay.lifestream.count.biz.model.dto.CountLikeUnlikeNoteMqDTO;
...
@Component
@RocketMQMessageListener(consumerGroup = "lifestream_group_" + MQConstants.TOPIC_LIKE_OR_UNLIKE, // Group 组
