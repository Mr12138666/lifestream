...
import com.sunrisejay.lifestream.count.biz.domain.mapper.CommentDOMapper;
import com.sunrisejay.lifestream.count.biz.enums.CommentLevelEnum;
import com.sunrisejay.lifestream.count.biz.model.dto.CountPublishCommentMqDTO;
...
@Component
@RocketMQMessageListener(consumerGroup = "lifestream_group_child_comment_total" + MQConstants.TOPIC_COUNT_NOTE_COMMENT, // Group 组
