...
import com.sunrisejay.lifestream.count.biz.domain.mapper.NoteCountDOMapper;
...
@Component
@RocketMQMessageListener(consumerGroup = "lifestream_group_" + MQConstants.TOPIC_COUNT_NOTE_LIKE_2_DB, // Group 组
