...
import com.sunrisejay.lifestream.count.biz.enums.CollectUnCollectNoteTypeEnum;
import com.sunrisejay.lifestream.count.biz.model.dto.CountCollectUnCollectNoteMqDTO;
...
@Component
@RocketMQMessageListener(consumerGroup = "lifestream_group_" + MQConstants.TOPIC_COUNT_NOTE_COLLECT, // Group 组
