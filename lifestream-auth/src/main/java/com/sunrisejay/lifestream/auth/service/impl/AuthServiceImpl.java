...
import com.sunrisejay.lifestream.auth.rpc.RpcService;
import com.sunrisejay.lifestream.auth.service.AuthService;
...
public class AuthServiceImpl implements AuthService {
    @Resource
    private RpcService userRpcService;
    ...
    public Response<String> loginAndRegister(UserLoginReqVO userLoginReqVO) {
        ...
        switch (loginTypeEnum) {
            ...
            case PASSWORD: // 密码登录
                ...
                FindUserByMailRspDTO findUserByPhoneRspDTO = userRpcService.findUserByMail(mail);
