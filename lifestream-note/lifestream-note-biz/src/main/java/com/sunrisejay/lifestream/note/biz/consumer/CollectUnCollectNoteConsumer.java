package com.sunrisejay.lifestream.note.biz.consumer;
...
@Component
@RocketMQMessageListener(consumerGroup = "lifestream_group_" + MQConstants.TOPIC_COLLECT_OR_UN_COLLECT, // Group 组
