...
import com.sunrisejay.lifestream.data.align.model.dto.LikeUnlikeNoteMqDTO;
...
@Component
@RocketMQMessageListener(consumerGroup = "lifestream_group_data_align_" + MQConstants.TOPIC_COUNT_NOTE_LIKE, // Group 组
