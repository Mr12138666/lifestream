...
import com.sunrisejay.lifestream.comment.biz.enums.LikeUnlikeCommentTypeEnum;
import com.sunrisejay.lifestream.comment.biz.model.dto.AggregationCountLikeUnlikeCommentMqDTO;
import com.sunrisejay.lifestream.comment.biz.model.dto.CountLikeUnlikeCommentMqDTO;
...
@Component
@RocketMQMessageListener(consumerGroup = "lifestream_group_count_" + MQConstants.TOPIC_COMMENT_LIKE_OR_UNLIKE, // Group 组
