package com.sunrisejay.lifestream.search.biz.service.impl;
...
import com.sunrisejay.framework.common.util.NumberUtils;
import com.sunrisejay.lifestream.dto.RebuildUserDocumentReqDTO;
import com.sunrisejay.lifestream.search.biz.domain.mapper.SelectMapper;
import com.sunrisejay.lifestream.search.biz.index.NoteIndex;
import com.sunrisejay.lifestream.search.biz.index.UserIndex;
...
import com.sunrisejay.lifestream.search.biz.service.UserService;
...
public class UserServiceImpl implements UserService {
    ...
    public PageResponse<SearchUserRspVO> searchUser(SearchUserReqVO searchUserReqVO) {
        ...
        // 构建 multi_match 查询，查询 nickname 和 lifestream_id 字段
        sourceBuilder.query(QueryBuilders.multiMatchQuery(
                keyword, UserIndex.FIELD_USER_NICKNAME, UserIndex.FIELD_USER_lifestream_ID));
        ...
        try {
            ...
            for (SearchHit hit : hits) {
                ...
                String lifestreamId = (String) sourceAsMap.get(UserIndex.FIELD_USER_lifestream_ID);
